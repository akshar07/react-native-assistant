  ...
  state = {
    ...
    render(){
      ...
      let buttons = categories.map(name => {
        return (
          <TouchableHighlight style={this.state[name] ? styles.selectedButton : styles.buttons} onPress={this.categoryPress.bind(this,name)} key={name}>
        ...
        return (
            <View style={[styles.container,styles.content]}>
                <View>
                 <Text>Please select the categories of news you are intrested in: </Text>
               ...
               <WeatherWidget
                  ...
                  lng={"-122.0307"}
                />
              <TouchableHighlight style={styles.doneButton} onPress={() => this.props.navigation.navigate('HomeScreen')}>
